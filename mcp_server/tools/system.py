    ...
    def check_version(self, proxy_url: Optional[str] = None) -> Dict:
        ...
        try:
            ...
            trendradar_url = advanced_config.get(
                "version_check_url",
                "https://raw.githubusercontent.com/ding5201008/TrendRadar/refs/heads/master/version"
            )
            mcp_url = advanced_config.get(
                "mcp_version_check_url",
                "https://raw.githubusercontent.com/ding5201008/TrendRadar/refs/heads/master/version_mcp"
            )
