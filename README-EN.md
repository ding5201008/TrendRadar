...
<a href="https://github.com/ding5201008/TrendRadar" title="TrendRadar">
  <img src="/_image/banner.webp" alt="TrendRadar Banner" width="80%">
</a>

Deploy in <strong>30 seconds</strong> — Say goodbye to endless scrolling, only see the news you truly care about

<a href="https://trendshift.io/repositories/14726" target="_blank"><img src="https://trendshift.io/api/badge/repositories/14726" alt="TrendRadar | Trendshift" style="width: 250px; height: 55px;" width="250" height="55"/></a>

[![GitHub Stars](https://img.shields.io/github/stars/ding5201008/TrendRadar?style=flat-square&logo=github&color=yellow)](https://github.com/ding5201008/TrendRadar/stargazers)
[![GitHub Forks](https://img.shields.io/github/forks/ding5201008/TrendRadar?style=flat-square&logo=github&color=blue)](https://github.com/ding5201008/TrendRadar/network/members)
[![License](https://img.shields.io/badge/license-GPL--3.0-blue.svg?style=flat-square)](LICENSE)
[![Version](https://img.shields.io/badge/version-v6.5.0-blue.svg)](https://github.com/ding5201008/TrendRadar)
[![MCP](https://img.shields.io/badge/MCP-v4.0.0-green.svg)](https://github.com/ding5201008/TrendRadar)
[![RSS](https://img.shields.io/badge/RSS-Feed_Support-orange.svg?style=flat-square&logo=rss&logoColor=white)](https://github.com/ding5201008/TrendRadar)
[![AI Translation](https://img.shields.io/badge/AI-Multi--Language-purple.svg?style=flat-square)](https://github.com/ding5201008/TrendRadar)
...
[![GitHub Actions](https://img.shields.io/badge/GitHub_Actions-Automation-2088FF?style=flat-square&logo=github-actions&logoColor=white)](https://github.com/ding5201008/TrendRadar)
[![GitHub Pages](https://img.shields.io/badge/GitHub_Pages-Deployment-4285F4?style=flat-square&logo=github&logoColor=white)](https://ding5201008.github.io/TrendRadar)
...
>**📌 Check Latest Updates**: **[Original Repository Changelog](https://github.com/ding5201008/TrendRadar?tab=readme-ov-file#-changelog)**:
...
**🐛 Bug Fix**
- Fixed issue where `ntfy_server_url` in `config.yaml` was ignored ([#345](https://github.com/ding5201008/TrendRadar/issues/345))
...
> Thanks to [nidaye996](https://github.com/ding5201008/TrendRadar/issues/98) for discovering the UX issue
...
- Fixed email notification config check being missed ([#88](https://github.com/ding5201008/TrendRadar/issues/88))
...
https://github.com/ding5201008/TrendRadar/blob/master/.github/workflows/crawler.yml
...
👉 **Try it online**: [https://ding5201008.github.io/TrendRadar/](https://ding5201008.github.io/TrendRadar/)
...
>
> **💡 Tip**: Enable GitHub Pages for an online URL. Go to Settings → Pages to enable. [Preview Effect](https://ding5201008.github.io/TrendRadar/)
>
...
> **Reminder**: You should first **[check the latest official documentation](https://github.com/ding5201008/TrendRadar?tab=readme-ov-file)** to ensure the configuration steps are up to date.
...
### 1️⃣ Step 1: Get project code
   ...
   > - Using Fork may cause runtime issues, see [Issue #606](https://github.com/ding5201008/TrendRadar/issues/606)
...
Method 1 discovered and suggested by **ziventian**, thanks to them. Default is personal push, group push can be configured via [#97](https://github.com/ding5201008/TrendRadar/issues/97)
...
>
> **Feedback Notice**:
> - If you successfully test with **other email providers**, please open an [Issue](https://github.com/ding5201008/TrendRadar/issues) to let us know, we'll add to support list
> - If above email configurations are incorrect or unusable, please also open an [Issue](https://github.com/ding5201008/TrendRadar/issues) for feedback to help improve the project
>
> **Special Thanks**:
> - Thanks to [@DYZYD](https://github.com/DYZYD) for contributing 189 Mail (189.cn) configuration and completing self-send-receive testing ([#291](https://github.com/ding5201008/TrendRadar/issues/291))
> - Thanks to [@longzhenren](https://github.com/longzhenren) for contributing Aliyun Mail (aliyun.com) configuration and completing testing ([#344](https://github.com/ding5201008/TrendRadar/issues/344))
> - Thanks to [@ACANX](https://github.com/ACANX) for contributing Yandex Mail (yandex.com) configuration and completing testing ([#663](https://github.com/ding5201008/TrendRadar/issues/663))
> - Thanks to [@Sleepy-Tianhao](https://github.com/Sleepy-Tianhao) for contributing iCloud Mail (icloud.com) configuration and completing testing ([#728](https://github.com/ding5201008/TrendRadar/issues/728))
...
1. **View Generated URL**:
   ...
   - Format: `https://hooks.slack.com/services/{team-id}/{channel-id}/{webhook-secret}`
...
### 3️⃣ Step 3: Manual Test News Push
   ...
   **Example comparison**:
   - ❌ Author's project: `https://github.com/ding5201008/TrendRadar/actions`
   ...
   **Testing steps**:
   ...
   2. Find **"Hot News Crawler"** and click in
      - If you don't see this text, refer to [#109](https://github.com/ding5201008/TrendRadar/issues/109) to solve
...
> 💡 **Shortcut**: If you don't know how to read source code, you can copy from others' organized [Platform Configuration Summary](https://github.com/ding5201008/TrendRadar/issues/95)
...
1. **Create Project Directory and Config**:
   ...
   git clone https://github.com/ding5201008/TrendRadar.git
   cd TrendRadar
   ```
...
[![Star History Chart](https://api.star-history.com/svg?repos=ding5201008/TrendRadar&type=Date)](https://www.star-history.com/#ding5201008/TrendRadar&Date)
