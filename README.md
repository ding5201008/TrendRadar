...
[![RSS](https://img.shields.io/badge/RSS-订阅源支持-orange.svg?style=flat-square&logo=rss&logoColor=white)](https://github.com/ding5201008/TrendRadar)
[![AI翻译](https://img.shields.io/badge/AI-多语言推送-purple.svg?style=flat-square)](https://github.com/ding5201008/TrendRadar)
...
[![GitHub Actions](https://img.shields.io/badge/GitHub_Actions-自动化-2088FF?style=flat-square&logo=github-actions&logoColor=white)](https://github.com/ding5201008/TrendRadar)
[![GitHub Pages](https://img.shields.io/badge/GitHub_Pages-部署-4285F4?style=flat-square&logo=github&logoColor=white)](https://ding5201008.github.io/TrendRadar)
...
> **📌 查看最新更新**：**[原仓库更新日志](https://github.com/ding5201008/TrendRadar?tab=readme-ov-file#-更新日志)** ：
...
- **频率词配置增强**：新增 `[组别名]` 语法，支持 `#` 注释行，配置更清晰（感谢 [@songge8](https://github.com/ding5201008/TrendRadar/issues/752) 提出的建议）
...
**🐛 Bug 修复**
- 修复 `config.yaml` 中 `ntfy_server_url` 配置不生效的问题 ([#345](https://github.com/ding5201008/TrendRadar/issues/345))
...
> 感谢 [nidaye996](https://github.com/ding5201008/TrendRadar/issues/98) 发现的体验问题
...
- 修正了邮件通知配置检查被遗漏的问题（[#88](https://github.com/ding5201008/TrendRadar/issues/88)）
...
👉 **在线体验**：[https://ding5201008.github.io/TrendRadar/](https://ding5201008.github.io/TrendRadar/)
...
>
> **💡 提示**：启用 GitHub Pages 可获得在线访问地址，进入仓库 Settings → Pages 即可开启。[效果预览](https://ding5201008.github.io/TrendRadar/)
>
...
> **提醒**：建议先 **[查看最新官方文档](https://github.com/ding5201008/TrendRadar?tab=readme-ov-file)**，确保配置步骤是最新的。
...
### 1️⃣ 第一步：获取项目代码
   ...
   > - 使用 Fork 可能导致运行异常，详见 [Issue #606](https://github.com/ding5201008/TrendRadar/issues/606)
...
### 2️⃣ 第二步：设置 GitHub Secrets
   ...
   **GitHub Secret 配置（⚠️ Name 名称必须严格一致）：**
   ...
   其中方案一，由 **ziventian**发现并提供建议，在这里感谢他，默认是个人推送，也可以配置群组推送操作[#97](https://github.com/ding5201008/TrendRadar/issues/97) ，
   ...
   **支持的邮箱服务商**（自动识别 SMTP 配置）：
   ...
   >
   > **反馈说明**：
   > - 如果你使用**其他邮箱**测试成功，欢迎开 [Issues](https://github.com/ding5201008/TrendRadar/issues) 告知，我会添加到支持列表
   > - 如果上述邮箱配置有误或无法使用，也请开 [Issues](https://github.com/ding5201008/TrendRadar/issues) 反馈，帮助改进项目
   >
   > **特别感谢**：
   > - 感谢 [@DYZYD](https://github.com/DYZYD) 贡献天翼邮箱（189.cn）配置并完成自发自收测试 ([#291](https://github.com/ding5201008/TrendRadar/issues/291))
   > - 感谢 [@longzhenren](https://github.com/longzhenren) 贡献阿里云邮箱（aliyun.com）配置并完成测试 ([#344](https://github.com/ding5201008/TrendRadar/issues/344))
   > - 感谢 [@ACANX](https://github.com/ACANX) 贡献 Yandex 邮箱（yandex.com）配置并完成测试 ([#663](https://github.com/ding5201008/TrendRadar/issues/663))
   > - 感谢 [@Sleepy-Tianhao](https://github.com/Sleepy-Tianhao) 贡献 iCloud 邮箱（icloud.com）配置并完成测试 ([#728](https://github.com/ding5201008/TrendRadar/issues/728))
   ...
   **设置步骤：**
   ...
   1. **查看生成的 URL**：
      ...
      - 格式如：`https://hooks.slack.com/services/{team-id}/{channel-id}/{webhook-secret}`
...
### 3️⃣ 第三步：手动测试新闻推送
   ...
   **示例对比**：
   - ❌ 作者的项目：`https://github.com/ding5201008/TrendRadar/actions`
   - ✅ 你的项目：`https://github.com/你的用户名/TrendRadar/actions`

   **测试步骤**：
   1. 进入你项目的 Actions 页面
   2. 找到 **"Get Hot News"**(必须得是这个字)点进去，点击右侧的 **"Run workflow"** 按钮运行 
      - 如果看不到该字样，参照 [#109](https://github.com/ding5201008/TrendRadar/issues/109) 解决
...
> 💡 **快捷方式**：如果不会看源代码，可以复制他人整理好的 [平台配置汇总](https://github.com/ding5201008/TrendRadar/issues/95)
